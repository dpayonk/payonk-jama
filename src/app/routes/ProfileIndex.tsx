...
class ProfileIndex extends React.Component<ProfileProps, ProfileState> {
    ...
    constructor(props: ProfileProps) {
        ...
        this.accountProfileService = new AccountProfileService();
    ...
    getProfileSyncState() {
        ...
        if (this.state.authenticationProfile.emailAddress !== this.props.userSession.accountProfile.emailAddress) {
    ...
    async componentDidMount() {
        try {
            ...
            if (authenticationProfile !== null && this.state.jwtToken !== null) {
                let accountProfile = await this.accountProfileService.fetchMyProfile(authenticationProfile);
                Logger.warn('Should we update the accountProfile of parent?', accountProfile);
                this.setState({ accountProfile: accountProfile });
            } else {
                this.setState({ alert: 'Your authentication profile could not be retrieved' });
            }
            ...
            return (
                <div className="box">
                    <div style={{ paddingBottom: "20px" }} id="account-profile">
                        ...
                        <div>
                            Your account profile could not be fetched
                        </div>
